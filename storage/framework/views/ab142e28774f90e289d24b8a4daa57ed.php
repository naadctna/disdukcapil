...
<body class="bg-gradient-to-br from-primary-50 via-purple-50 to-indigo-100 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
        ...
        <div class="mb-8">
            ...
            <a href="<?php echo e(url('/kelurahan')); ?>" class="inline-flex items-center text-primary-600 hover:text-primary-700 mb-4 font-semibold">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-2">
                <span class="bg-gradient-to-r from-primary-600 to-indigo-600 bg-clip-text text-transparent">
                    Data Kelurahan
                    <?php if(request('kecamatan')): ?>
                    <span class="text-2xl">- <?php echo e(request('kecamatan')); ?></span>
                    <?php endif; ?>
                </span>
            </h2>
            ...
            <div class="gradient-card rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($kelurahan->count())); ?></p>
                        <?php if(request('kecamatan')): ?>
                        <p class="text-xs text-gray-500 mt-1">di <?php echo e(request('kecamatan')); ?></p>
                        <?php endif; ?>
                    </div>
            ...
            <div class="gradient-card rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($kelurahan->sum('datang'))); ?></p>
                    </div>
            ...
            <div class="gradient-card rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2"><?php echo e(number_format($kelurahan->sum('pindah'))); ?></p>
                    </div>
        ...
        <!-- Search Bar & Filter -->
        <div class="mb-6">
            <form method="GET" action="<?php echo e(url('/kelurahan')); ?>" class="flex gap-3 flex-wrap">
                <?php if(request('kecamatan')): ?>
                <input type="hidden" name="kecamatan" value="<?php echo e(request('kecamatan')); ?>">
                <?php endif; ?>
                ...
                <?php if($search || $jenis): ?>
                <a href="<?php echo e(url('/kelurahan' . (request('kecamatan') ? '?kecamatan=' . urlencode(request('kecamatan')) : ''))); ?>" class="bg-gray-200 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-300 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                        ...
                        <tr class="hover:bg-primary-50/50 transition-colors duration-200">
                            ...
                            <td class="px-6 py-4 text-sm font-medium text-gray-900">
                                <div class="flex items-center space-x-2">
                                    ...
                                    <span><?php echo e($item['kelurahan']); ?></span>
                                </div>
                            </td>
            ...
            <div class="gradient-card rounded-xl p-6 shadow-lg">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-lg font-bold text-gray-900"><?php echo e($kelurahan->sortByDesc('datang')->first()['kelurahan']); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($kelurahan->sortByDesc('datang')->first()['kecamatan'] ?? '-'); ?></p>
                        <p class="text-2xl font-bold text-green-600 mt-1"><?php echo e(number_format($kelurahan->sortByDesc('datang')->first()['datang'])); ?></p>
                    </div>
                    <div class="bg-gradient-to-br from-green-400 to-green-600 p-3 rounded-xl shadow-lg">
            ...
            <div class="gradient-card rounded-xl p-6 shadow-lg">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-lg font-bold text-gray-900"><?php echo e($kelurahan->sortByDesc('pindah')->first()['kelurahan']); ?></p>
                        <p class="text-xs text-gray-500"><?php echo e($kelurahan->sortByDesc('pindah')->first()['kecamatan'] ?? '-'); ?></p>
                        <p class="text-2xl font-bold text-red-600 mt-1"><?php echo e(number_format($kelurahan->sortByDesc('pindah')->first()['pindah'])); ?></p>
                    </div>
                    <div class="bg-gradient-to-br from-red-400 to-red-600 p-3 rounded-xl shadow-lg">
                        <svg class="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M19 12h-2v3h-3v2h5v-5zM7 9h3V7H5v5h2V9zm14-6H3c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H3V5h18v14z"/>
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xs text-gray-500 mt-1">
                            <?php echo e($selisih >= 0 ? 'Surplus' : 'Defisit'); ?> populasi
                        </p>
                    </div>
...
<?php /**PATH D:\laragon\www\disdukcapil\resources\views/kelurahan.blade.php ENDPATH**/ ?>