                ...
                <div class="bg-purple-50 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-4xl font-bold text-gray-900 mb-1">{{ number_format($rekapitulasi->total_datang) }}</p>
                ...
                <div class="bg-purple-50 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-4xl font-bold text-gray-900 mb-1">{{ number_format($rekapitulasi->total_pindah) }}</p>
                            <p class="text-purple-500 text-sm">2024 - 2025</p>
                        </div>
                ...
                <div class="bg-purple-50 rounded-2xl p-6 hover:shadow-md transition-all duration-300">
                    <div class="flex items-start justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-4xl font-bold {{ $rekapitulasi->hasil_akhir >= 0 ? 'text-green-600' : 'text-red-600' }} mb-1">
                                {{ $rekapitulasi->hasil_akhir >= 0 ? '+' : '' }}{{ number_format($rekapitulasi->hasil_akhir) }}
                            </p>
                            <p class="text-purple-500 text-sm">{{ $rekapitulasi->hasil_akhir >= 0 ? 'Surplus' : 'Defisit' }}</p>
                        </div>
                        <div class="bg-green-500 p-3 rounded-xl shadow-md flex-shrink-0 ml-4">
                            <svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
