...
<body class="bg-gradient-to-br from-primary-50 via-purple-50 to-indigo-100 min-h-screen">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12">
            ...
            <div class="gradient-card rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($kecamatan->count()) }}</p>
                    </div>
            ...
            <div class="gradient-card rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($kecamatan->sum('datang')) }}</p>
                    </div>
            ...
            <div class="gradient-card rounded-2xl p-6 shadow-xl hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($kecamatan->sum('pindah')) }}</p>
                    </div>
        ...
        <!-- Search Bar & Filter -->
        <div class="mb-6">
            <form method="GET" action="{{ url('/kecamatan') }}" class="flex gap-3 flex-wrap">
                ...
                @if($search || $jenis)
                <a href="{{ url('/kecamatan') }}" class="bg-gray-200 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:bg-gray-300 transition-all duration-200 flex items-center space-x-2">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <table class="w-full">
                    ...
                    <tbody class="bg-white/50 divide-y divide-primary-100">
                        ...
                        <tr class="hover:bg-primary-50/50 transition-colors duration-200 cursor-pointer group" 
                            onclick="window.location.href='{{ url('/kelurahan?kecamatan=' . urlencode($item['kecamatan'])) }}'">
            ...
            <div class="gradient-card rounded-xl p-6 shadow-lg">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl font-bold text-gray-900">{{ $kecamatan->sortByDesc('datang')->first()['kecamatan'] }}</p>
                        <p class="text-2xl font-bold text-green-600 mt-1">{{ number_format($kecamatan->sortByDesc('datang')->first()['datang']) }}</p>
                    </div>
                    <div class="bg-gradient-to-br from-green-400 to-green-600 p-3 rounded-xl shadow-lg">
            ...
            <div class="gradient-card rounded-xl p-6 shadow-lg">
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-xl font-bold text-gray-900">{{ $kecamatan->sortByDesc('pindah')->first()['kecamatan'] }}</p>
                        <p class="text-2xl font-bold text-red-600 mt-1">{{ number_format($kecamatan->sortByDesc('pindah')->first()['pindah']) }}</p>
                    </div>
                    <div class="bg-gradient-to-br from-red-400 to-red-600 p-3 rounded-xl shadow-lg">
                        <svg class="w-6 h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                            <path d="M16 17.01V10h-2v7.01h-3L15 21l4-3.99h-3zM9 3L5 6.99h3V14h2V6.99h3L9 3z"/>
